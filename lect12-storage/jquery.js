...
// By default, when #button is clicked, #blue-box's (the parent) click event ALSO gets triggered. This is known as event propagation or event bubbling 
$("#button").on("click", function(event) {
    // this method will stop the propagation from happening
